...
pub fn contains(self: *HugeAllocTable, ptr: *const anyopaque) bool {
    self.rwlock.lockShared();
...
pub fn containsRaw(self: *HugeAllocTable, ptr: *const anyopaque) bool {
    return self.hash_map.contains(@intFromPtr(ptr));
}

pub fn remove(self: *HugeAllocTable, ptr: *const anyopaque) bool {
    self.rwlock.lock();
...
pub fn removeRaw(self: *HugeAllocTable, ptr: *const anyopaque) bool {
...
pub fn putAssumeCapacityNoClobber(self: *HugeAllocTable, ptr: *const anyopaque, size: usize) !void {
    self.rwlock.lock();
    defer self.rwlock.unlock();
...
pub fn putAssumeCapacityNoClobberRaw(self: *HugeAllocTable, ptr: *const anyopaque, size: usize) void {
    return self.hash_map.putAssumeCapacityNoClobber(@intFromPtr(ptr), size);
}

pub fn putAssumeCapacity(self: *HugeAllocTable, ptr: *const anyopaque, size: usize) void {
    self.rwlock.lock();
    defer self.rwlock.unlock();
...
pub fn putAssumeCapacityRaw(self: *HugeAllocTable, ptr: *const anyopaque, size: usize) void {
    return self.hash_map.putAssumeCapacity(@intFromPtr(ptr), size);
}

pub fn putNoClobber(self: *HugeAllocTable, allocator: Allocator, ptr: *const anyopaque, size: usize) !void {
    self.rwlock.lock();
    defer self.rwlock.unlock();
...
pub fn putNoClobberRaw(self: *HugeAllocTable, allocator: Allocator, ptr: *const anyopaque, size: usize) !void {
    return self.hash_map.putNoClobber(allocator, @intFromPtr(ptr), {}, size);
}

pub fn put(self: *HugeAllocTable, allocator: Allocator, ptr: *const anyopaque, size: usize) !void {
    self.rwlock.lock();
    defer self.rwlock.unlock();
...
pub fn putRaw(self: *HugeAllocTable, allocator: Allocator, ptr: *const anyopaque, size: usize) !void {
    return self.hash_map.put(allocator, @intFromPtr(ptr), size);
}

pub fn get(self: *HugeAllocTable, ptr: *const anyopaque) ?usize {
    self.rwlock.lockShared();
    defer self.rwlock.unlockShared();
...
pub fn getRaw(self: *HugeAllocTable, ptr: *const anyopaque) ?usize {
